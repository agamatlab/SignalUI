...
public class PIControllerPlugin : IStageControllerPlugin
{
    ...
    public bool IsCompatible()
    {
        ...
        var pluginDir = System.IO.Path.GetDirectoryName(GetType().Assembly.Location);
        if (pluginDir == null) return false;
        
        var dllPath64 = System.IO.Path.Combine(pluginDir, "PI_GCS2_DLL_x64.dll");
        var dllPath32 = System.IO.Path.Combine(pluginDir, "PI_GCS2_DLL.dll");
        ...
        Console.WriteLine($"[PIPlugin]   Plugin directory: {pluginDir}");
    ...
    public global::StageController CreateController(PluginConfiguration config)
    {
